...
const Login = () => {
  ...
  return (
    <div >
      {login?<h1 className='flex justify-center text-5xl my-10 not_Center'>Login</h1>:<h1 className='flex justify-center text-5xl my-10 not_Center'>Signup</h1>}
      <span className='flex justify-center text-red-400 not_Center'>{error.text}</span>
      <span className='flex justify-center text-red-400 not_Center'>{msg.text}</span>
        {login && <form action="get" className='pt-5 not_Center'>
            ...
            <input type='button' className='setter not_Center' value="Create Account"onClick={(e)=>{e.preventDefault(); setLogin(false)}}></input>
        </form>}
        {!login && <form action="get" className='pt-5 not_Center'>
            ...
            <input type='button' className='setter not_Center' value="Already Have Account"onClick={(e)=>{e.preventDefault(); setLogin(true)}}></input>
        </form>
        }
